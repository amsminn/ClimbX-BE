...
VALUES (1, 'RATING', 2500, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 'RATING', 1500, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (3, 'RATING', 1200, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (1, 'RANKING', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 'RANKING', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (3, 'RANKING', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (1, 'SOLVED_COUNT', 200, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 'SOLVED_COUNT', 75, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (3, 'SOLVED_COUNT', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (1, 'RATING', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 'RATING', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (3, 'RATING', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (1, 'SOLVED_COUNT', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 'SOLVED_COUNT', 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (3, 'SOLVED_COUNT', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
