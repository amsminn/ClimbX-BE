...
INSERT INTO submissions (video_id,
                         ...
                         updated_at,
                         deleted_at)
VALUES (1, 2, 3, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (2, 3, 2, 'REJECTED', 'Insufficient explanation', 'REJECTED', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, NULL),
       (3, 1, 1, 'PENDING', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (4, 2, 1, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (5, 2, 2, 'ACCEPTED', 'Duplicate submission', 'REJECTED', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, NULL),
       (6, 2, 3, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (7, 2, 1, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (8, 3, 2, 'REJECTED', 'Incorrect solution', 'REJECTED', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, NULL),
       (9, 1, 3, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
       (10, 2, 1, 'ACCEPTED', NULL, 'PENDING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
